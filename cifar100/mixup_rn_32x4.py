...
"""## <font color = 'lightblue'>**Model Training With MixUp**</font>"""

net_mix = resnet32x4(num_classes=100)
net_mix = net_mix.to(device)
criterion_mix = nn.CrossEntropyLoss().to(device)
...
checkpoint = os.path.join('./weights/resnet_32x4/mixup')
...
for epoch in range(epochs):
    ...
    ece, bin_acc, bin_conf, acc, bin_count = compute_calibration_metrics(num_bins=NUM_BINS, net=net_mix, loader=test_loader, device=device)
