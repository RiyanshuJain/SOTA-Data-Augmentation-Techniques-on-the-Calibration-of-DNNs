...
"""## <font color = 'lightblue'>**Model Training With CutOut**</font>"""

net_co = resnet32x4(num_classes = 100)
net_co = net_co.to(device)
criterion_co = nn.CrossEntropyLoss(size_average=True).to(device)
...
checkpoint = os.path.join('./weights/resnet_32x4/cutout')
...
for epoch in range(epochs):
    ...
    ece, bin_acc, bin_conf, acc, bin_count = compute_calibration_metrics(num_bins=NUM_BINS, net=net_co, loader=test_loader, device=device)
